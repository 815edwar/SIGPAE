...
class ModelsTestCase(TestCase):
    def setUp(self):
        ...
        self.programa3 = Programa.objects.create(
            ...
            obj_e="Aprender serie de McLaurin, la de Taylor y los métodos para resolver"\
    ...
    def test_estrategias_metodologicas(self):
        ...
        self.assertEqual(self.transcripcion3.estrategias_metodologicas,
                         "Clases a distancia y algunas sesiones personales.")
    ...
    def test_estrategias_evaluacion(self):
        ...
        self.assertEqual(self.transcripcion2.estrategias_evaluacion, "Un trabajo,
                         una exposición y veinte mini-proyectos.")
    ...
    def test_fuentes_informacion(self):
        self.assertEqual(self.transcripcion1.ftes_info_recomendadas,
                         "Aho, A., Lam, M., Sethi, R., y Ullman, J. Compilers.")
    ...
    def test_departamento(self):
        ...
        self.assertEqual(self.transcripcion2.departamento.__str__(),
                         "Departamento de Computación y Tecnología de Información")
        self.assertEqual(self.transcripcion3.departamento.__str__(),
    ...
    # Se prueba el campo "decanato", el cual es una clave foránea de otra clase.
    ...
    def test_nombre_coord(self):
        self.assertEqual(self.coordinacion1.nombre,
                         "Coordinación de Comercio Exterior y Licenciatura en Comercio Internacional")
    ...
    def test_objetivos_generales(self):
        self.assertEqual(self.programa1.obj_g,
                         "Desallorar competencias a nivel de optimización de recursos y recorrido óptimo de caminos.")
        ...
        self.assertEqual(self.programa4.obj_g,
                         "Extender el conocimiento de física básico con conceptos como el torque y el momento angular.")

    # Se prueba el campo "objetivos_especificos" y su correctitud.
    def test_objetivos_especificos(self):
        self.assertEqual(self.programa1.obj_e,
                         "Aprender el método SIMPLEX, aprender sobre problemas de transporte y trasbordo.")
        self.assertEqual(self.programa2.obj_e, "Leer 'Ética para Amador' y otras lecturas random.")
        self.assertEqual(self.programa3.obj_e,
                         "Aprender serie de McLaurin, la de Taylor y los métodos para resolver"
                         "ecuaciones diferenciales ordinarias.")
        self.assertEqual(self.programa4.obj_e,
                         "Aprender dinámica rotacional, aspectos de gravitación universal y termodinámica.")
    ...
    def test_estrategias_evaluacion_prog(self):
        ...
        self.assertEqual(self.programa2.estrat_eval,
                         "Tres exámenes parciales, el primero y el segundo de 35 %, el último de 30 %.")
    ...
    def test_porrevisarP_sol(self):
        if self.solicitud1.porrevisarP:
    ...
    def test_horas_teoria_sol(self):
        if self.solicitud1.horas_teoria:
    ...
    def test_horas_laboratorio_sol(self):
        if self.solicitud1.horas_laboratorio:
    ...
    def test_trim_pensum_sol(self):
        if self.solicitud1.trim_pensum:
    ...
    def test_permiso_coord_sol(self):
        if self.solicitud1.permiso_coord:
